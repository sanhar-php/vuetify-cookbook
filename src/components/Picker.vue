<template>
  <div>
    <v-layout class="text-xs-center">
      <v-flex xs12>
        <h2><a href="https://vuetifyjs.com/zh-Hans/components/date-pickers">日期</a>/<a href="https://vuetifyjs.com/zh-Hans/components/time-pickers">时间</a>选择器组件的使用</h2>
      ...
      <v-flex xs11 sm5>
        ...
        >
          ...
          <v-time-picker
            v-model="time"
            format="24hr"
            @change="$refs.timeMenu.save(time+':00')"
          ></v-time-picker>
        </v-menu>
      </v-flex>
    </v-layout>
